...
class LivrablePartielController extends AbstractController
{
     ...
     * )
     */
    public function updateStatusLivrable(EntityManagerInterface $em,Request $request,LivrablePartielsRepository $livpartielRepo, ApprenantRepository $apprenantRepository, $id, $idl)
    {
